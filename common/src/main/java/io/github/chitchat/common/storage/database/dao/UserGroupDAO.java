...
public interface UserGroupDAO {
    ...
    @Transaction
    @SqlUpdate(
            "insert into user_group (user_id, group_id, modified_at) values (:user.id, :group.id, :modified_at)")
    ...
    @Transaction
    @SqlUpdate(
            "update user_group set user_id = :user.id, group_id = :group.id, modified_at = :modified_at")
